...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-swgd0gc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-swgd0gc.containers.anotherwebservice.com/
...
```
git clone git@github.com:Aluisyo/container-swgd0gc.git
cd container-swgd0gc
```
...
```
docker attach container-swgd0gc
```
